...
//Execute the query
mysqli_query($connect, "INSERT INTO task (task_name,task_description,task_recursion,assign_to,assign_by,task_status)
				VALUES('$task_name','$task_description','$task_recursion','$assign_to','$assign_by','$task_status')");
...
if($task_recursion=='customize'){
	...
	mysqli_query($connect, "INSERT INTO daily_task (day,dtime_start,dtime_end,dtask_duration,task_id)
