...
<head>
      ...
      <script type="text/javascript">
       ...
       function calculateTime() {
           ...
           $("p[name='x']").html("<b>Hour Difference:</b> " + Math.abs(hourDiff) + " hr/s")
      ...
      <script type="text/javascript">
       ...
       function calculateTime() {
           ...
           $("p[name='y']").html("<b>Hour Difference:</b> " + Math.abs(hourDiff) + " hr/s")
      ...
      <script type="text/javascript">
       ...
       function calculateTime() {
           ...
           $("p[name='z']").html("<b>Hour Difference:</b> " + Math.abs(hourDiff) + " hr/s")
